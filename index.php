...
<html lang="en">
    ...
    <body>
        <h2>ข้อมูลนักเรียน ปีการศึกษา 2567</h2>     
                ...
                <tbody>
                    <?php while($row=mysqli_fetch_assoc($result)){?>
                        <tr>
                            ...
                            <td><center><a href="delete.php?deletedid=<?php echo $row["std_id"];?>"
                            onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')">ลบข้อมูล</center></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>           
